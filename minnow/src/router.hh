...
struct routeEntry {
    ...
    // min_ip_address is the lowest ip address in the range of ip addresses
    // specified by route_prefix and prefix_length
    uint32_t min_ip_address{};
};

//struct routeCompare {
//    bool operator()(const uint32_t &ip1, const uint32_t &ip2) const {
//        return ip1 < ip2;
//    }
//};
